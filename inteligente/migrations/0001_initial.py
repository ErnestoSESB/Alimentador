...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('feeder_name', models.CharField(max_length=100, verbose_name='Nome do Alimentador')),
                ('type', models.CharField(choices=[('low_food', 'Nível Baixo de Ração'), ('maintenance', 'Manutenção Necessária'), ('error', 'Erro no Sistema'), ('offline', 'Equipamento Offline')], max_length=20, verbose_name='Tipo')),
                ('message', models.TextField(verbose_name='Mensagem')),
                ('severity', models.CharField(choices=[('low', 'Baixo'), ('medium', 'Médio'), ('high', 'Alto')], default='medium', max_length=10, verbose_name='Severidade')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('admin', 'Administrador'), ('farmer', 'Agricultor'), ('operator', 'Operador')], default='operator', max_length=20)),
