...
class FeederAdmin(admin.ModelAdmin):
    list_display = ('name', 'location', 'status', 'food_level', 'owner', 'last_maintenance')
...
class AlertAdmin(admin.ModelAdmin):
    list_display = ('feeder_name', 'type', 'severity', 'resolved', 'created_at', 'resolved_at')
    list_filter = ('type', 'severity', 'resolved', 'created_at')
    search_fields = ('feeder__name', 'message')
    fields = ('feeder', 'type', 'severity', 'resolved', 'created_at', 'resolved_at', 'message')
